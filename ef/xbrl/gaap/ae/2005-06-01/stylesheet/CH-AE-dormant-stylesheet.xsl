...
<!-- $Id: CH-AE-dormant-stylesheet.xsl,v 1.11 2006-02-17 08:50:10 sanstiss Exp $ -->
...
<xsl:if test="//ae:ForeignExchangeRate"><li><!--<a name="fn_exchange_rate"/>-->Exchange Rate<br />
